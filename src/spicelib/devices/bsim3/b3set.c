/* $Id: b3set.c,v 1.1.1.1 2000/04/27 20:03:59 pnenzi Exp $  */
/*
 $Log: b3set.c,v $
 ...
 *
*/
static char rcsid[] = "$Id: b3set.c,v 1.1.1.1 2000/04/27 20:03:59 pnenzi Exp $";
