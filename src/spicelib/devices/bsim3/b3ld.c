/* $Id: b3ld.c,v 1.1.1.1 2000/04/27 20:03:59 pnenzi Exp $  */
/*
 $Log: b3ld.c,v $
 ...
 *
*/
static char rcsid[] = "$Id: b3ld.c,v 1.1.1.1 2000/04/27 20:03:59 pnenzi Exp $";
...
finished: 
	  ...
	  {   /*  charge storage elements
	       ...
	       *  czbsswg: zero bias source junction sidewall capacitance
              ...
              { 
              czbdswg = model->BSIM3unitLengthGateSidewallJctCap 
		      * here->BSIM3drainPerimeter;
              czbdsw = 0.0;
              }
              else
	      ...
	      czbdswg = model->BSIM3unitLengthGateSidewallJctCap
		      *  pParam->BSIM3weff;
              ...
              {
              czbssw = 0.0; 
	      czbsswg = model->BSIM3unitLengthGateSidewallJctCap
		      * here->BSIM3sourcePerimeter;
              }
              else
              {
